          ...
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown dropdown-user">
              <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                ...
                <span class="username username-hide-on-mobile"> Isacc Lozano </span>
              </a>
              <ul class="dropdown-menu dropdown-menu-default">
                <li>
                  <a href="page_user_profile_1.html">
                    <i class="icon-user"></i> Configuración </a>
                </li>
                <li class="divider"> </li>
                <li>
              ...
              <ul class="sub-menu">
                ...
                <li class="nav-item  ">
                  <a href="ui_general.html" class="nav-link ">
                    ...
                    <span class="title">Acreedores</span>
                  </a>
                </li>
                <li class="nav-item  ">
              ...
              <ul class="sub-menu">
                ...
                <li class="nav-item  ">
                  <a href="form_controls_md.html" class="nav-link ">
                    ...
                    <span class="title">Órdenes de Compra</span>
                  </a>
                </li>
                <li class="nav-item  ">
                  <a href="form_validation.html" class="nav-link ">
                    <i class="fa fa-file-text-o"></i>
                    <span class="title">Órdenes de Carga</span>
                  </a>
                </li>
                <li class="nav-item  ">
                  <a href="form_validation_states_md.html" class="nav-link ">
                    <i class="fa fa-file-o"></i>
                    <span class="title">Remisión</span>
                  </a>
                </li>
              </ul>
            </li>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="dashboard-stat blue">
                ...
                <div class="details">
                  <div class="number">
                    <span data-counter="counterup" data-value="1345">0</span>
                  </div>
