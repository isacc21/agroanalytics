...
$consultarProductos = $ordenesCompra->consultarOrdenes();
...
foreach ($result as $row){
  ...
  $html_vencida='<span class="label label-sm label-info"> Agregada </span>';
   ...
   <div class="col-md-12">
    ...
    <div class="portlet light bordered">
     ...
     <div class="actions btn-set">
       <button type="button" name="back" id="back_cat_ocrem" class="btn btn-secondary-outline">
 ...
 <tbody>
  ...
  <label for="factura'.$codigo.'" ">  <i class="fa fa-paperclip"></i>&nbsp;Agregar factura </label></a></li>';
