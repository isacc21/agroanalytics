...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#cancelarBankD").submit(function(e){ 
			...
			$.ajax({
				type: "POST",
				url: "../../../controllers/almacen/ordenesCarga/nuevaCarga.php",
				data: "folio="+$("#folio").val()+
				'&pass='+$("#pass").val()
			}).done(function(result){
				if(result=="Orden de Carga registrada"){
					swal({
						title: result,
						type: "success",
...
<div class="col-md-12">
	...
	<div class="portlet box grey-steel">
		...
		<div class="portlet-title">
			...
			<div class="caption"><div class="font-grey-mint"><b>Procesar pedido: "<?php echo $codigo;?>"</b> </div></div>
