...
$codigo=(isset($_REQUEST['folio']))?$_REQUEST['folio']:"";
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#cancelarBankD").submit(function(e){ 
			...
			$.ajax({
				type: "POST",
				url: "../../../controllers/contabilidad/cuentasCobrar/cancelarCuenta.php",
				data: "folio="+$("#folio").val()+
				'&pass='+$("#pass").val()
			}).done(function(result){
				if(result=="Cuenta cancelada"){
					swal({
						title: result,
						type: "success",
					...
					$("#mainContent").load( "cat_cuentasCobrar.php?moneda="+<?=$_REQUEST['moneda']; ?> );
				}else{
					swal({
						title: result,
						type: "warning",
...
<div class="col-md-12">
	...
	<div class="portlet box grey-steel">
		...
		<div class="portlet-title">
			...
			<div class="caption"><div class="font-grey-mint"> <b>Saldar cuenta: "<?php echo $codigo;?>"</b> </div></div>
