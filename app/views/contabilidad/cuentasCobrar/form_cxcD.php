...
###### CREACION DEL OBJETO ACREEDORES PARA UTILIZAR SUS METODOS ######################
	$usdCuentasC = new usdCuentasC($datosConexionBD);
	$usdCuentasC->folio = $codigo;

	$result = $usdCuentasC->consultarCuentasCxID();
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if ($("#accionBoton").val() == 'Guardar'){
			var urlCont = "../../../controllers/contabilidad/usd/cuentasCobrar/guardarCXC.php";
		} /* LLAVE DE IF */


		else if($("#accionBoton").val() == 'Actualizar'){
			var urlCont = "../../../controllers/contabilidad/usd/cuentasCobrar/modificarCXC.php";
		} /* LLAVE DE ELSE */
		...
		$("#guardarCXC").submit(function(e){
			...
			if($("#ingreso").val==""){
				swal("Error", "Seleccione un cliente", warning)
			}
			else{
	...
	<div class="portlet box blue-hoki">
		...
		<div class="portlet-title">
			...
			<div class="caption">
				...
				<i class="fa fa-save"></i> Nueva cuenta por cobrar 
			</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<div class="input-group  date date-picker" data-date="<?=$ddCXC."/".$mmCXC."/".$yyyyCXC;?>" data-date-format="dd/mm/yyyy" data-date-viewmode="days">
								<input type="text" class="form-control readonly"  id="fechaCXC" required value="<?=$ddCXC."/".$mmCXC."/".$yyyyCXC;?>">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<select id="cliente" class="form-control input-circle" required >
								<option <? echo $seleccionada;?> disabled value="">Seleccione un cliente</option>
								<?php 
								$seleccionada = "";
								$clientes=$usdCuentasC->consultarClientes();
								foreach($clientes as $row){
									...
									?>
									<option value="<?=$rfc;?>" <?php echo $seleccionada;?>><? echo $nombre;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-4 col-md-12">
									...
									<a href="../cuentasCobrar" class="btn btn-circle grey-salsa btn-outline">Cancelar</a>
								</div>
							</div>
						</div>
