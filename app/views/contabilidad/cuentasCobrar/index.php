...
# 02 Abril 2017 : 01:46                                                              #
#                                                                                    #
###### cuentasCobrar/index.php #######################################################
#                                                                                    #
# Archivo de Inicio sección cuentas por cobrar                                       #
#                                                                                    #
...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    $html_dolares='<div class="col-md-6">
    <div class="mt-widget-3">
        <div class="mt-head bg-green-jungle">
            <div class="mt-head-icon">
                <i class="fa fa-dollar"></i>&nbsp;<strong>USD</strong>
            </div>
            <div class="mt-head-desc"> Registros en dólares</div>
            <div class="mt-head-button">
                <button type="button" id="cuentasC_dolares" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';

    $html_pesos='<div class="col-md-6">
    <div class="mt-widget-3">
        <div class="mt-head bg-blue-soft">
            <div class="mt-head-icon">
                <i class="fa fa-usd"></i>&nbsp;<strong>MXN</strong>
            </div>
            <div class="mt-head-desc"> Registros en pesos </div>
            <div class="mt-head-button">
                <button type="button" id="cxc_pesos" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
                            ...
                            <div class="page-sidebar-wrapper">
                                ...
                                <div class="page-content-wrapper">
                                    <div class="page-content">
                                        ...
                                        <h1 class="page-title"> Cuentas por Cobrar
                                            ...
                                            <div class="portlet light portlet-fit bordered">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject font-green-sharp bold uppercase">Seleccione la moneda</span>
                                                    </div>
                                                </div>
