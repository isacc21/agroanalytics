...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
	...
	$html_inicio_conta='<li class="nav-item start active open ">
	<a href="javascript:;" class="nav-link nav-toggle">
	...
	$html_cxc='<li class="nav-item active open ">
	...
	$html_titulo_dolares =  '<div class="row"><div class="col-md-4"><h1 class="page-title"><b>Dólares</b></h1></div></div><div class="clearfix"></div>';
	$html_inicio_menu_dolares = '<div class="row">';
	$html_registro_dolares = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="nuevo_cxcd"><div class="visual"><i class="fa fa-plus-circle"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Registro</b></h3></div></div></a></div>';
	$html_lista_dolares = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="lista_cxcd"><div class="visual"><i class=" fa fa-list"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Catálogo</b></h3></div></div></a></div>';
	$html_reporte_dolares = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 green-seagreen" id="rep_dolares_cxc"><div class="visual"><i class="fa fa-print"></i></div><div class="details"><div class="number"><h3><b>Reporte</b></h3></div></div></a></div>';
	$html_fin_menu_dolares = '</div><div class="clearfix"></div>';

	$html_titulo_pesos =  '<div class="row"><div class="col-md-4"><h1 class="page-title"><b>Pesos</b></h1></div></div><div class="clearfix"></div>';
	$html_inicio_menu_pesos = '<div class="row">';
	$html_registro_pesos = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="nuevo_cxcp"><div class="visual"><i class="fa fa-plus-circle"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Registro</b></h3></div></div></a></div>';
	$html_lista_pesos = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="lista_cxcp"><div class="visual"><i class=" fa fa-list"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Catálogo</b></h3></div></div></a></div>';
	$html_reporte_pesos = '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 green-seagreen" id="rep_pesos_cxc"><div class="visual"><i class="fa fa-print"></i></div><div class="details"><div class="number"><h3><b>Reporte</b></h3></div></div></a></div>';
	$html_fin_menu_pesos = '</div><div class="clearfix"></div>';
	...
	<head>
		<meta charset ="utf-8" />
		<title>Agroanalytics - Cuentas por cobrar</title>
							...
							<ul class="nav navbar-nav pull-right">
								<li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
									...
									<ul class="dropdown-menu">
											...
											<div class="page-sidebar-wrapper">
												...
												<div class="page-content-wrapper">
													...
													<div class="page-content">
														...
														<h1 class="page-title"> <b>Cuentas por cobrar</b><br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
														...
														<div id="mainContent" class="page-container">
															...
															<?php 
															if($cxc[0]=='1'){
																echo $html_titulo_dolares;
															}
															if($cxc!='0000'){
																echo  $html_inicio_menu_dolares;	
															}

															if($cxc[1]=='2'){
																echo 	$html_registro_dolares;
															}

															if($cxc!='0000'){
																echo $html_lista_dolares;

															}
															if($cxc[0]=='1'){
																echo $html_reporte_dolares;
															}

															if($cxc!='0000'){
																echo $html_fin_menu_dolares;
															}

															if($cxc[0]=='1'){
																echo $html_titulo_pesos;
															}
															if($cxc!='0000'){
																echo  $html_inicio_menu_pesos;	
															}

															if($cxc[1]=='2'){
																echo 	$html_registro_pesos;
															}

															if($cxc!='0000'){
																echo $html_lista_pesos;

															}
															if($cxc[0]=='1'){
																echo $html_reporte_pesos;
															}

															if($cxc!='0000'){
																echo $html_fin_menu_pesos;
															}
															?>
										...
										<script src="../../../../assets/js/menu_conta.js" type="text/javascript"></script>
