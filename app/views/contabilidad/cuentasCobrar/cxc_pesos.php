...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
    ...
    <div class="mt-widget-3">
    	<div class="mt-head bg-green-jungle">
    		...
    		<div class="mt-head-desc">Registrar nueva orden por cobrar</div>
    		<div class="mt-head-button">
    			<button type="button" id="add_cxcD" class="btn btn-circle btn-outline white btn-sm">Registrar</button>
    		</div>
    	</div>
    </div></div>';
    ...
    <div class="mt-widget-3">
    	<div class="mt-head bg-green-haze">
    		...
    		<div class="mt-head-desc"> Lista de cuentas por cobrar </div>
    		<div class="mt-head-button">
    			<button type="button" id="list_cxcD" class="btn btn-circle btn-outline white btn-sm">Consultar</button>
    		</div>
    	</div>
    </div></div>';
