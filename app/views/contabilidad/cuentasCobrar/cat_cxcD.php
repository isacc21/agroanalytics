...
$listaCXC = $usdCuentasC->consultarCuentasC();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdCuentasC->consultarCuentasC();
    ...
    <div class="portlet light bordered">
     ...
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_cc1" class="btn btn-secondary-outline">
