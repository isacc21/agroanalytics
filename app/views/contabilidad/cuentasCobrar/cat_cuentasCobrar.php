...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
  ...
  $html_pagada='<div class="text-center"><span class="label label-sm label-success"> Saldada </span></div>';
  ...
  $html_pagada_left='<div class="text-left"><span class="label label-sm label-success"> Saldada </span></div>';
