...
$listaCXC = $usdCuentasC->consultarRegistradas();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdCuentasC->consultarRegistradas();
...
foreach ($result as $row){
  ...
  <div class="col-md-6">
  	<div class="btn-group">
  		<button id="goto_cxcUSD" class="btn sbold green"> 
  ...
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <a href="#" id="cxc_pend">
        <i class="fa fa-calendar-minus-o"></i> Solo pendientes a cobro 
      </a>
    </li>
    <li>
      <a href="#" id="cxc_cancel">
  ...
  $html_pendiente='<span class="label label-sm label-warning"> Pendiente a cobro </span>';
    ...
    <div class="portlet light bordered">
     ...
     <div class="portlet-title">
      ...
      <div class="caption font-dark">
       ...
       <span class="caption-subject bold uppercase"> Listado de Cuentas: Pendientes a cobro</span>
     </div>
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_cc3" class="btn btn-secondary-outline">
...
<tbody>
  <?php
  foreach($listaCXC as $row){
    $codigo = $row['folioCuentaC'];
    $dd = $row['ddCuentaC'];
    $mm = $row['mmCuentaC'];
    ...
    <?php 
    $usdCuentasC->rfc = $rfc;
    $consultarCliente = $usdCuentasC->consultarClientesxID();
    foreach($consultarCliente as $row){
...
<script>
    ...
    $("#back_cat_cc3").click(function(){
          window.location = ""
        });

    /* SCRIPT PARA CAMBIAR CONTENIDO POR FORMULARIO EN BLANCO */
    $("#cxc_all").click(function(){
      $("#mainContent").load( "cat_cxcD.php" );
    });

    /* SCRIPT PARA CAMBIAR CONTENIDO POR FORMULARIO EN BLANCO */
    $("#cxc_pend").click(function(){
      $("#mainContent").load( "cat_cxcD_pend.php" );
    });

    /* SCRIPT PARA CAMBIAR CONTENIDO POR FORMULARIO EN BLANCO */
    $("#cxc_cancel").click(function(){
      $("#mainContent").load( "cat_cxcD_cancel.php" );
    });

    /* SCRIPT PARA CAMBIAR CONTENIDO POR FORMULARIO EN BLANCO */
    $("#cxc_sald").click(function(){
      $("#mainContent").load( "cat_cxcD_sald.php" );
    });



		/* SCRIPT PARA CAMBIAR CONTENIDO POR FORMULARIO EN BLANCO */
		$("#goto_cxcUSD").click(function(){
		...
		$('.editar').click(function() {
			$("#mainContent").load( "form_cxcD.php?codigo="+$(this).val());
