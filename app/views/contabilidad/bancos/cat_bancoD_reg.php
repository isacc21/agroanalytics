...
$listaBancos = $usdBancos->consultarRegistradosUSD();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdBancos->consultarRegistradosUSD();
    ...
    <div class="portlet light bordered">
     ...
     <div class="portlet-title">
      ...
      <div class="caption font-dark">
       ...
       <span class="caption-subject bold uppercase"> Estado de Cuenta: Registrados</span>
     </div>
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_b4" class="btn btn-secondary-outline">
