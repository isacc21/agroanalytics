...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    <div class="mt-widget-3">
        <div class="mt-head bg-green-jungle">
            ...
            <div class="mt-head-button">
                <button type="button" id="sec_dolares" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3">
        <div class="mt-head bg-blue-soft">
            ...
            <div class="mt-head-button">
                <button type="button" id="sec_pesos" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
