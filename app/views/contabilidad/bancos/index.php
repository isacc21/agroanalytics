...
# 23 Febrero 2017 : 21:07                                                            #
#                                                                                    #
###### acreedores/index.php ##########################################################
#                                                                                    #
...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
	...
	$html_bancos='<li class="nav-item  active open ">
	...
	<head>
		<meta charset ="utf-8" />
		<title>Agroanalytics - Bancos</title>
									...
									<ul class="dropdown-menu">
											...
											<div class="page-sidebar-wrapper">
												...
												<div class="page-content-wrapper">
													...
													<div class="page-content">
														...
														<h1 class="page-title"> <b>Bancos</b><br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
														...
														<div id="mainContent" class="page-container">
															...
															foreach($lista_bancos as $row){
																...
																if($banco[0]=='1'){
																	echo '<div class="row"><div class="col-md-4"><h1 class="page-title"> <b>'.$nombre.$moneda_t.'</b></h1></div></div><div class="clearfix"></div>';
																}
																if($banco!='0000'){
																	echo  '<div class="row">';	
																}
																...
																if($banco[1]=='2'){
																	echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="add_rbanco'.$x.'"><div class="visual"><i class="fa fa-plus-circle"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Registro</b></h3></div></div></a></div>';	
																}

																if($banco!='0000'){
																	echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="list_rbanco'.$x.'"><div class="visual"><i class=" fa fa-list"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Catálogo</b></h3></div></div></a></div>';

																}
																if($banco[0]=='1'){
																	echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 green-seagreen" id="rep_rbanco'.$x.'"><div class="visual"><i class="fa fa-print"></i></div><div class="details"><div class="number"><h3><b>Reporte</b></h3></div></div></a></div>';
																}

																if($banco!='0000'){
																	echo '</div><div class="clearfix"></div>';
																}
																echo '<input type="hidden" id="bank'.$x.'" value="'.$codigo.'">';
																$x++;
															}
															?>
										...
										<script type="text/javascript">
											$(document).ready(function(){
												...
												<?php 
												for ($i = 0; $i < $x; $i++) {
													echo '$("#list_rbanco'.$i.'").click(function(){
														var envio = $("#bank'.$i.'").val();
														$("#mainContent").load( "cat_bancos.php?banco="+envio );
													});';
													echo '$("#add_rbanco'.$i.'").click(function(){
														var envio = $("#bank'.$i.'").val();
														$("#mainContent").load( "form_bancos.php?banco="+envio );
													});';
													echo '$("#rep_rbanco'.$i.'").click(function(){
														var envio = $("#bank'.$i.'").val();
														$("#mainContent").load( "cat_bancos_all.php?banco="+envio );
													});';
												}
												?>
