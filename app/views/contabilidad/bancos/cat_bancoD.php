...
$listaBancos = $usdBancos->consultarRegistrosBancoUSD();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdBancos->consultarRegistrosBancoUSD();
...
foreach ($result as $row){
  ...
  $balance_gral = $total_ingreso - $total_egreso;
    ...
    <div class="portlet light bordered">
     ...
     <div class="portlet-title">
      ...
      <div class="caption font-dark">
       ...
       <span class="caption-subject bold uppercase"> Estado de Cuenta | Banorte USD</span>
     </div>
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_b1" class="btn btn-secondary-outline">
...
<tbody>
  ...
  <td> <?php if($tipo==1){echo "$ ".$num;}else{echo "$ ".number_format($otro,2, '.', ',');}?></td>
  <td> <?php if($tipo==2){echo "$ ".$num;}else{echo "$ ".number_format($otro,2, '.', ',');;}?></td>
