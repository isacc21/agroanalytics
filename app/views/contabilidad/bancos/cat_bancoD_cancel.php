...
$listaBancos = $usdBancos->consultarCanceladosUSD();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdBancos->consultarCanceladosUSD();
    ...
    <div class="portlet light bordered">
     ...
     <div class="portlet-title">
      ...
      <div class="caption font-dark">
       ...
       <span class="caption-subject bold uppercase"> Estado de Cuenta: Cancelados</span>
     </div>
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_b2" class="btn btn-secondary-outline">
