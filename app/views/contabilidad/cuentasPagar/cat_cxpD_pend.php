...
$listaCXP = $usdCuentasP->consultarRegistradas();


###### CONSULTA DE ACREEDORES PARA VENTANAS MODALES ##################################
$consultaModal = $usdCuentasP->consultarRegistradas();
    ...
    <div class="portlet light bordered">
     ...
     <div class="portlet-title">
      ...
      <div class="caption font-dark">
       ...
       <span class="caption-subject bold uppercase"> Listado de Cuentas: Pendientes a pago</span>
     </div>
     <div class="actions">
      <div class="btn-group btn-group-devided" data-toggle="buttons">
        <?echo $html_filtros;?>
        <button type="button" name="back" id="back_cat_cp3" class="btn btn-secondary-outline">
