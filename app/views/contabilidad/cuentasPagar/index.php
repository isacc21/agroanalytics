...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    $html_cxp='<li class="nav-item active open">
    ...
    <div class="mt-widget-3">
        <div class="mt-head bg-green-jungle">
            ...
            <div class="mt-head-button">
                <button type="button" id="cuentasP_dolares" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3">
        <div class="mt-head bg-blue-soft">
            ...
            <div class="mt-head-button">
                <button type="button" id="cxp_pesos" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
                            ...
                            <div class="page-sidebar-wrapper">
                                ...
                                <div class="page-content-wrapper">
                                    <div class="page-content">
                                        ...
                                        <h1 class="page-title"> Cuentas por Pagar
