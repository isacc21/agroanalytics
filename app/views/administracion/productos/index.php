...
# 21 Febrero 2017 : 12:22                                                            #
#                                                                                    #
###### productos/index.php ###########################################################
#                                                                                    #
# Archivo de Inicio sección productos                                                #
#                                                                                    #
###### HISTORIAL DE MODIFICACIONES ###################################################
#                                                                                    #
# 21-FEB-17: 12:23                                                                   #
# IJLM - Se copia INDEX de usuarios                                                  #
# IJLM - Se realizan los cambios pertinentes a la sección productos.                 #
#                                                                                    #
# 23-FEB-17: 14:54                                                                   #
# IJLM - Se agregaron LINK Y SCRIPT para uso de ventanas modales                     #
#                                                                                    #
# 24-FEB-17: 17:55                                                                   #
# IJLM - Se documentó el código totalmente para su mejor entendimiento a futuro      #
#																		                                                 #
# 25-FEB-17: 07:44																                                   # 
...
###### MODULO DE ADMINISTRACION #####################################################
	...
	<head>
		<meta charset ="utf-8" />
		<title>Agroanalytics - Productos</title>
													...
													<div class="page-content">
														...
														<div id="mainContent" class="page-container">
															...
															<div class="row">
																...
																<!--INICIA CUADRO PARA REGISTRO DE PRODUCTO-->
																<?php 
																if($productos[1]=='2'){
																	echo $html_registro;
																}
																?>
																<!--TERMINA CUADRO PARA REGISTRO DE PRODUCTO-->

																<!--INICIA CUADRO PARA LISTA DE PRODUCTOS-->
																<?php 
																if($productos[0]=='1'||$productos[2]=='3'||$productos[3]=='4'){
																	echo $html_consulta;
																}
																?>
																<!--TERMINA CUADRO PARA LISTA DE PRODUCTOS-->
																
																<!--INICIA CUADRO PARA REPORTE DE PRODUCTOS-->
																<?php 
																if($productos[0]=='1'||$productos[2]=='3'||$productos[3]=='4'){
																	echo $html_reporte;
																}
																?>
																<!--TERMINA CUADRO PARA REPORTE DE PRODUCTOS-->
															</div>
															<!--TERMINA ROW -->
