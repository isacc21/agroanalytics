...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
	...
	<div class="mt-widget-3 bg-red">
		<div class="mt-head bg-red">
			...
			<div class="mt-head-desc"> Registrar un nuevo transportista</div>
			<div class="mt-head-button">
				<button type="button" id="add_trans" class="btn btn-circle btn-outline white btn-sm">Registro</button>
			</div>
		</div>
	</div></div>';
	...
	<div class="mt-widget-3 bg-blue-hoki">
		<div class="mt-head bg-blue-hoki">
			...
			<div class="mt-head-desc"> Lista de transportistas registrados</div>
			<div class="mt-head-button">
				<button type="button" id="list_trans" class="btn btn-circle btn-outline white btn-sm">Consultar</button>
			</div>
		</div>
	</div></div>';
	...
	<div class="mt-widget-3 bg-green">
		<div class="mt-head bg-green">
			...
			<div class="mt-head-desc"> Reporte de transportistas </div>
			<div class="mt-head-button">
							...
							<div class="page-sidebar-wrapper">
								...
								<div class="page-content-wrapper">
									...
									<div class="page-content">
										...
										<h1 class="page-title"> Transportistas<br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
