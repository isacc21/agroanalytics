...
# 28 Febrero 2017 : 17:11                                                            #
#                                                                                    #
###### transportistas/index.php ######################################################
#                                                                                    #
# Archivo de Inicio sección transportista                                            #
#                                                                                    #
...
###### FOREACH PARA CONSULTA DE PERMISOS #############################################
	...
	$html_transportistas = '<li class="nav-item active open ">
	...
	$html_registro='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="add_trans"><div class="visual"><i class="fa fa-plus-circle"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Registro</b></h3></div></div></a></div>';

	$html_consulta='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="list_trans"><div class="visual"><i class=" fa fa-list"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Catálogo</b></h3></div></div></a></div>';

	$html_reporte='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 green-seagreen" id="rep_trans"><div class="visual"><i class="fa fa-print"></i></div><div class="details"><div class="number"><h3><b>Reporte</b></h3></div></div></a></div>';
	?>
	...
	<head>
		<meta charset ="utf-8" />
		<title>Agroanalytics - Transportistas</title>
							...
							<div class="page-sidebar-wrapper">
								...
								<div class="page-content-wrapper">
									...
									<div class="page-content">
										...
										<h1 class="page-title"> <b>Transportistas</b><br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
										...
										<div id="mainContent" class="page-container">
											...
											<div class="row">
												...
												<!--INICIA CUADRO PARA REGISTRO DE TRANSPORTISTA-->
												<?php 
												if($transportistas[1]=='2'){
													echo $html_registro;
												}
												?>
												<!--TERMINA CUADRO PARA REGISTRO DE TRANSPORTISTA-->

												<!--INICIA CUADRO PARA LISTA DE TRANSPORTISTAS-->
												<?php 
												if($transportistas[0]=='1'||$transportistas[2]=='3'||$transportistas[3]=='4'){
													echo $html_consulta;
												}
												?>
												<!--TERMINA CUADRO PARA LISTA DE TRANSPORTISTAS-->

												<!--INICIA CUADRO PARA REPORTE DE TRANSPORTISTAS-->
												<?php 
												if($transportistas[0]=='1'||$transportistas[2]=='3'||$transportistas[3]=='4'){
													echo $html_reporte;
												}
												?>
												<!--TERMINA CUADRO PARA REPORTE DE TRANSPORTISTAS-->
											</div>
											<!--TERMINA ROW -->
