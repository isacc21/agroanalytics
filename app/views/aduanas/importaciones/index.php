...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    <div class="mt-head bg-red">
            ...
            <div class="mt-head-desc"> Registrar nueva importacion</div>
            <div class="mt-head-button">
                <button type="button" id="add_importacion" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3 bg-blue-hoki">
        <div class="mt-head bg-blue-hoki">
            ...
            <div class="mt-head-button">
                <button type="button" id="list_importacion" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3 bg-green">
        <div class="mt-head bg-green">
            ...
            <div class="mt-head-desc"> Reporte de importaciones </div>
            <div class="mt-head-button">
                <button type="button" id="rep_importacion" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ?>
                            ...
                            <div class="page-sidebar-wrapper">
                                ...
                                <div class="page-content-wrapper">
                                    <div class="page-content">
                                        ...
                                        <h1 class="page-title"> Importaciones<br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
