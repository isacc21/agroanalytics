...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    $html_importaciones='<li class="nav-item start active">
    ...
    $html_nuevo='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="add_importacion"><div class="visual"><i class="fa fa-plus-circle"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Registro</b></h3></div></div></a></div>';

    $html_lista='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 grey-steel" id="list_importacion"><div class="visual"><i class=" fa fa-list"></i></div><div class="details"><div class="number"><h3 class="font-grey-mint"><b>Catálogo</b></h3></div></div></a></div>';

    $html_reporte='<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a class="dashboard-stat dashboard-stat-v2 green-seagreen" id="rep_importacion"><div class="visual"><i class="fa fa-print"></i></div><div class="details"><div class="number"><h3><b>Reporte</b></h3></div></div></a></div>';
    ...
    <head>
        <meta charset ="utf-8" />
        <title>Agroanalytics - Importaciones</title>
                            ...
                            <div class="page-sidebar-wrapper">
                                ...
                                <div class="page-content-wrapper">
                                    <div class="page-content">
                                        ...
                                        <h1 class="page-title"> <b>Importaciones</b><br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
                                      ...
                                      <div id="mainContent" class="page-container">
                                        ...
                                        <div class="row">
                                            ...
                                            if($importaciones[0]=='1'||$importaciones[2]=='3'||$importaciones[3]=='4'){
                                                echo $html_lista;
                                                echo $html_reporte;
                                            }
                                            ?>
