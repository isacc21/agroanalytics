...
###### MODULO DE ADMINISTRACION #####################################################
    ...
    <div class="mt-widget-3 bg-blue-hoki">
        <div class="mt-head bg-blue-hoki">
            ...
            <div class="mt-head-desc"> Lista de declaraciones </div>
            <div class="mt-head-button">
                <button type="button" id="list_declaracion" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3 bg-green">
        <div class="mt-head bg-green">
            ...
            <div class="mt-head-desc"> Reporte de declaración </div>
            <div class="mt-head-button">
                <button type="button" id="rep_declaracion" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ?>
