  ...
  <div class="portlet box blue-hoki">
    ...
    <div class="portlet-title">
      ...
      <div class="caption">
        ...
        <i class="fa fa-save"></i> Registro de Cotizacion 
      </div>
        ...
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <i class="col-md-3 icon-calculator btn btn-icon-only btn-lg white" id="calc_total"></i>          
    ...
    <script type="text/javascript">
        ...
        $( "#nuevoProducto" ).append('<div class="form-group" id="remover'+x+'"><label class="col-md-3 control-label">Productos</label><div class="col-md-3"><select id="producto'+x+'" class="form-control" required ><option selected disabled value="default">Seleccione</option><?php 
          ...
          foreach($productos as $row){
            ...
            switch($presP){
              ...
              $preS = " | SS";
              break;
            }?><option value="<?=$codigoP;?>"><? echo $nombreP.$preS;?></option><?php } ?></select></div><div class="col-md-3"> <input type="text" class="form-control" id="cantidad'+x+'" name="cantidad" value="" placeholder="Cantidad" required "></div><div class="col-md-2"> <div class="btn blue-chambray btn-outline" onclick="removerProducto('+x+')"><i class="glyphicon glyphicon-trash"></i></div></div></div>');
        x++;
      });
      productoEliminado = [];
      ...
      $("#nuevoProducto").change(function(e){
       ...
       for (var i = 0; i < registros; i++) {
         ...
         if(conf_del != undefined){
          cuenta = 1;
        }
        for (var j = 0; j < registros-1; j++) {
          if(j!=i){
            if(cuenta!=1){
              if($("producto"+i).val() == $("producto"+i).val())
