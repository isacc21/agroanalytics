   ...
   ###### MODULO DE ADMINISTRADOR ###############################################
    ...
    <div class="mt-widget-3 bg-red">
        <div class="mt-head bg-red">
            ...
            <div class="mt-head-desc"> Registrar nueva cotización</div>
            <div class="mt-head-button">
                <button type="button" id="add_coti" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3 bg-blue-hoki">
        <div class="mt-head bg-blue-hoki">
            ...
            <div class="mt-head-desc"> Lista de Cotizaciones </div>
            <div class="mt-head-button">
                <button type="button" id="list_coti" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ...
    <div class="mt-widget-3 bg-green">
        <div class="mt-head bg-green">
            ...
            <div class="mt-head-button">
                <button type="button" id="rep_coti" class="btn btn-circle btn-outline white btn-sm">Seleccionar</button>
            </div>
        </div>
    </div></div>';
    ?>
                            ...
                            <div class="page-sidebar-wrapper">
                                ...
                                <div class="page-content-wrapper">
                                    <div class="page-content">
                                        ...
                                        <h1 class="page-title"> Cotizaciones<br /><small>GO Products S. de R.L de C.V.</small><br /><small><?php echo date(d) ."/". date(m) ."/". date(Y); ?></small></h1>
